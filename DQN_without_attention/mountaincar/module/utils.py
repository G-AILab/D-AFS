...
def fc(x, scope, nh, init_scale=1, init_bias=0):
    ...
    with tf.variable_scope(scope):
        ...
        w = tf.get_variable("w", [nin,nh], initializer=tf.truncated_normal_initializer(stddev=init_scale))
...
def function(inputs, outputs, updates=None, givens=None):
    """
    f(inputs)-->ouputs，compute outputs
    Example:
        ...
        with tf.Session() as sess:
            ...
            print(lin(x=2, y=3)) 
    ----------
    inputs: [tf.placeholder, tf.constant, or object with make_feed_dict method]"make_feed_dict"
