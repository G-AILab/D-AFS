...
#             all_rewards[-1] = 0.0
    ...
    # all_states = np.array(all_states).reshape(total_timesteps, 6)
    # all_rewards = np.array(all_rewards).reshape(total_timesteps, 1)
    # pd.DataFrame(all_states).to_csv('all_states.csv', header=['a1', 'a2', 'a3', 'a4', 'a5', 'a6', 'a7', 'a8', 'a9', 'a10'], index=False)
